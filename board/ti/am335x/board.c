...
//Page 1
	{CMD, 0xFF, 0},
		{DAT, 0xFF, 0}, {DAT, 0x98, 0}, {DAT, 0x06, 0}, {DAT, 0x04, 0}, {DAT, 0x01, 0},
//Output   SPI using SDI/SDO, SDO goes tristate
	{CMD, 0x08, 0},
		{DAT, 0x10, 0},
//DE = 1 Active, PCLK Fetch on falling
	{CMD, 0x21, 0},
		{DAT, 0x03, 0},
//Panel Control 2 - Normally Black
	{CMD, 0x23, 0},
		{DAT, 0x00, 0},
//Data Complement Setting - expand lsbs on 16 bit data (default)
	{CMD, 0x24, 0},
		{DAT, 0x03, 0},
...
//Power Control 2
	{CMD, 0x41, 0}, 	//
		{DAT, 0x66, 0},
//Power Control 3   (default)
	{CMD, 0x42, 0}, 	//
		{DAT, 0x02, 0},
//Power Control 4 (default)
	{CMD, 0x43, 0},
		{DAT, 0x09, 0},
//Power Control 5 (clamp disable, -12V)
	{CMD, 0x44, 0},
		{DAT, 0x0c, 0},
//Power Control 6	(+/- 9V)
	{CMD, 0x45, 0},
		{DAT, 0x14, 0},
//Power Control 9 (default)
	{CMD, 0x50, 0},
		{DAT, 0x78, 0},
//Power Control 10 (default)
	{CMD, 0x51, 0},
		{DAT, 0x78, 0},
//VCOM Control 1~2 (Flicker)
	{CMD, 0x52, 0},
		{DAT, 0x00, 0},
	{CMD, 0x53, 0},
		{DAT, 0x75, 0},
//Source Timing Adjust 1~3
	{CMD, 0x60, 0},
		{DAT, 0x07, 0},
	{CMD, 0x61, 0},
		{DAT, 0x06, 0},
...
//Negative Gamma Correction 1~16
	{CMD, 0xC0, 0},
		{DAT, 0x00, 0},
	{CMD, 0xC1, 0},
		{DAT, 0x1C, 0},
...
//What is this command?
	{CMD, 0x02, 0},
		{DAT, 0x77, 0},
//Page 0 in preparation for following commands
	{CMD, 0xFF, 0},
		{DAT, 0xFF, 0}, {DAT, 0x98, 0}, {DAT, 0x06, 0}, {DAT, 0x04, 0}, {DAT, 0x00, 0},
//INVOFF
	{CMD, 0x20, 0},
//Interface Pixel Format: 24 bit display
	{CMD, 0x3A, 0},
		{DAT, 0x70, 0},
//Write CTRL Display Value - Disable Brightness control
	{CMD, 0x53, 0},
		{DAT, 0x00, 0},
	{END}
};
...
void lcd_enable(void)
{
	...
	case CORDIAL_REV1:
		...
		break;
	default:
		printf("Invalid cordial revision %u, default to 2\n", rev);
		/* FALLTHROUGH */
	case CORDIAL_REV2:
